export default function Incentives() {
  ...
  type Perk = {
    name: string;
    imageComponent: React.FC; // Change the type to React functional component
    description: string;
  };

  const MoneyBackGuaranteesvg = () => (
    <svg
    className=" -my-1 mx-auto h-24 w-auto orange-500"
  ...
  const perks: Perk[] = [
    {
      ...
      imageComponent: MoneyBackGuaranteesvg,
      description:
        "Not what you expected? Place it back in the parcel and attach the pre-paid postage stamp.",
    },
    {
      name: "Continual Support",
      imageComponent: Deliverysvg,
      description:
        "We offer a delivery service that has never been done before. Checkout today and receive your products within hours.",
    },
    {
      name: "Free Delivery",
      imageComponent: Contactsvg,
      description:
  ...
  return (
    <>
      <section
        ...
        className="border-t border-orange-200  bg-black"
      >
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-20 lg:px-8">
          <div className="grid grid-cols-1 gap-y-12 sm:grid-cols-3 sm:gap-x-6 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-0">
            {perks.map((perk) => (
              <div
                key={perk.name}
                className="text-center md:flex md:items-center md:text-center  lg:text-center"
              >
