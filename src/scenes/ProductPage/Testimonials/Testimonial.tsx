...
export default function Testimonial({
  ...
  return (
    <div className="flex  justify-center">
      <div className="flex  mx-1 my-1 p-1 lg:w-5/6 md:w-5/6 sm:w-5/6 xs:w-5/6 xxs:w-5/6   border-dotted    border-3 border-secondary-500">
            ...
            <figcaption className="flex mt-6 space-x-3 rtl:space-x-reverse">
              <div className="flex flex-col items-start ">
                <div className="flex flex-row gap-1">
                  ...
                  <div className="  max-w-fit max-h-fit my-auto    text-xs tracking-tight text-green-500 text-center">
                    ✅ verified Buyer
                  </div>
                </div>
                <div>
